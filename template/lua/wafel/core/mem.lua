...
function mem.query_base(input, predictive)
    if base_mem and base_mem:dict_lookup(input, predictive, 100) then
...
---@param predictive boolean
---@return fun(): DictEntry|nil
function mem.query_full(input, predictive)
    if full_mem and full_mem:dict_lookup(input, predictive, 100) then
